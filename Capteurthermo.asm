...
init:
			...
			ldi b1,0b00000001	; Tref MSByte : Tsup (initialement) = 20C
			ldi a0,0b11100000	; Tsup LSByte
			ldi a1,0b00000001	; Tsup MSByte : Tsup (initialement) = 30C
			ldi a2,0b10100000	; Tinf LSByte
			ldi a3,0b00000000	; Tinf MSByte : Tinf (initialement) = 10C
...
.db "Set Tsup", LF, 0
			PRINTF LCD
.db "Tsup =",FFRAC2+FSIGN, a, 4, $42, LF, 0
